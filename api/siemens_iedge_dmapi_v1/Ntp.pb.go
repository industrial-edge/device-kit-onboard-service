...
type Status struct {
	...
	PeerDetails           []*PeerDetails `protobuf:"bytes,5,rep,name=peerDetails,proto3" json:"peerDetails,omitempty"`                     // NTPQ peer information array. Only exist if time is synced.
}
...
type NtpServiceClient interface {
	//Set ntp server
	SetNtpServer(ctx context.Context, in *Ntp, opts ...grpc.CallOption) (*empty.Empty, error)
	//Returns ntp servers
	GetNtpServer(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Ntp, error)
...
func (c *ntpServiceClient) SetNtpServer(ctx context.Context, in *Ntp, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *ntpServiceClient) GetNtpServer(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Ntp, error) {
	out := new(Ntp)
...
func (c *ntpServiceClient) GetStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type NtpServiceServer interface {
	//Set ntp server
	SetNtpServer(context.Context, *Ntp) (*empty.Empty, error)
	//Returns ntp servers
	GetNtpServer(context.Context, *empty.Empty) (*Ntp, error)
	//Returns NTP Status message.
	GetStatus(context.Context, *empty.Empty) (*Status, error)
}

// UnimplementedNtpServiceServer can be embedded to have forward compatible implementations.
type UnimplementedNtpServiceServer struct {
}

func (*UnimplementedNtpServiceServer) SetNtpServer(context.Context, *Ntp) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetNtpServer not implemented")
}
func (*UnimplementedNtpServiceServer) GetNtpServer(context.Context, *empty.Empty) (*Ntp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNtpServer not implemented")
}
func (*UnimplementedNtpServiceServer) GetStatus(context.Context, *empty.Empty) (*Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStatus not implemented")
}

func RegisterNtpServiceServer(s *grpc.Server, srv NtpServiceServer) {
	s.RegisterService(&_NtpService_serviceDesc, srv)
}
...
func _NtpService_GetNtpServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NtpServiceServer).GetNtpServer(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NtpService_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NtpServiceServer).GetStatus(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

var _NtpService_serviceDesc = grpc.ServiceDesc{
